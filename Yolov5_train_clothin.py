...
if __name__ == '__main__':
    ...
    train_param.batch_size = 2  ## depends on your GPU card
    ...
    train_param.weights = "./weights/yolov5s_clothing.pt"   #yolov5s_E_Coli.pt" ## if pretrained wieght then ''
    ...
    #train_param.notest = False
    train_param.name = "Clothing"
