...
if __name__ == '__main__':
    ...
    train_param.cfg = "./models/yolov5s_capacitor.yaml" 
    ##  define data source: 必須在該檔案中定義資料來源
    train_param.data = "./data/capacitor.yaml"  ##
    train_param.weights = "./weights/yolov5s_capacitor.pt" #clothing_best.pt" ## if pretrained wieght then ''
